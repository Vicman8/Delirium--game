...
public class DanaIntro extends Script {
    ...
    public ArrayList<ScriptAction> loadScriptActions() {
        ...
        scriptActions.add(new TextboxScriptAction() {{
            ...
            addText("Preeda: Don’t ever attempt anything like that again!\nYou could’ve been killed!");
            addText("Kaegen: Fine.");
            addText("Preeda: Wait, didn’t you say you were going to\nthe dining hall? Lemme grab you something.");
